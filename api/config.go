...
type NavySealsConfig struct {
    ...
    BindAddress int  `env:"BIND_ADDRESS"            long:"bind" short:"b" description:"bind address" yaml:"bind"`
	Port int  `env:"PORT"            long:"port" description:"port number (integer, maximum 65535)" yaml:"port"`
	Log struct {
